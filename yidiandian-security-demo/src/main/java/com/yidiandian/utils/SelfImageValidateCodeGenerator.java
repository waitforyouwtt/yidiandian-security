 ...
 */
//value 值等于ValidateCodeBeanConfig    @ConditionalOnMissingBean(name = "codeGenerator")
@Component("imageValidateCodeGenerator")
public class SelfImageValidateCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode generateCode(ServletWebRequest request) {
        ...
        return  new ImageCode(bi,random,securityProperties.getCode().getImage().getExpireIn());
    }
